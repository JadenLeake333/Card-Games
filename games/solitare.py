...
class card_game:
    ...
    def draw_cards(self) -> tuple:
        ...
        for deck in self.cards:
            ...
            if turnover == 3 :
                ...
                cards.append(Cards(card_path,deck,(100,100),(random.randint(0,self.width-100),random.randint(0,self.height-100)),(0,0), outline = True))
            else:
    ...
    def play_game(self):
        ...
        while 1:
            ...
            self.update_text(len(self.cards)-1,start_time)
